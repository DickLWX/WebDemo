...
<title>首页</title>
<!--Jquery-->
    <script type="text/javascript" src="${path}/webdemo/js/jquery-3.2.1.min.js"></script>

    <!--背景CSS-->
    <link rel="stylesheet" media="screen" href="${path}/webdemo/css/background.css">

    <!--bootstrap字体-->
    <link rel="stylesheet" href="${path}/webdemo/bootstrap-3.3.7-dist/css/bootstrap.css"/>

    <link href="${path}/webdemo/imgs/favicon.ico" type="image/x-icon" rel="shortcut icon"/>

        <!--导航条CSS-->
    <link rel="stylesheet" href="${path}/webdemo/css/navbar.css"/>




    <!--弹出框-->
    <script src="${path}/webdemo/js/sweetalert.min.js"></script>
    <link rel="stylesheet" type="text/css" href="${path}/webdemo/css/sweetalert.css">
    ...
    <script>
        var path = "";
         $(function () {
            ...
            path = prePath+"/webdemo";
            console.log(path);
        }); 
    </script>

    <!--清除所有默认样式-->
    <link rel="stylesheet" href="${path}/webdemo/css/cleanDefault.css"/>

    <!--获取用户的身份信息，如果用户已登陆，那么将用户身份信息显示出来-->
    <%-- <script src="${path}/webdemo/js/getUser.js"></script> --%>
...
<div id="particles-js">
    ...
    <nav>
        ...
        <div>
            <a href="${path}/webdemo/goURL/user/toRegister.do" id="registerDiv">
                <div>
                    <h1>注册</h1>
                    <span></span>
                </div>
...
<!--导航条JS-->
<script src="${path}/webdemo/js/narbar.js"></script>
